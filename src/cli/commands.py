...
from src.server.databricks_permissions_mcp_server import DatabricksPermissionsMCPServer, main as server_main
...
def parse_args(args: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Databricks Permissions MCP Server CLI")
...
def show_version() -> None:
    ...
    server = DatabricksPermissionsMCPServer()
    print(f"\nDatabricks Permissions MCP Server v{server.version}")
