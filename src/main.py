"""
Main entry point for the Databricks Permissions MCP server.
"""
...
async def main():
    ...
    logger.info(f"Starting Databricks Permissions MCP server v{settings.VERSION}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Databricks Permissions MCP Server")
    parser.add_argument(
        "--log-level",
